...
<div className="Home">
    <section className="homeIntro">
        ...
        <div className="homeText">
            <h1 className="homeTextTitle">Austin Haubenschild<br/>Fullstack Developer</h1>
        </div>
        <div className="homeText2">
            ...
            <p className="aboutMe">Currently, I am in the process of transitioning my career focus into software development. I will be completing my software development bootcamp through General Assembly on May 16th where I have developed my skills in Node, React, Express, SQL, Javascript, and Python. During my time at General Assembly, I have also worked towards many IT certifications. Among others, I have achieved the AWS Certified Solutions Architect - Associate and the Google Associate Cloud Engineer.</p>
