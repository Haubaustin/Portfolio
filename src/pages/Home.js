...
<div className="Home">
    <section className="homeIntro">
        ...
        <div className="homeText">
            ...
            <p className="aboutMe">Currently, I am in the process of transitioning my career focus into software development. I completed a software development bootcamp through General Assembly on May 16th, 2022 where I developed my skills in Node, React, Express, SQL, Javascript, and Python. During my time at General Assembly, I also worked towards many IT certifications. Among others, I have achieved the AWS Certified Solutions Architect - Associate and the Google Associate Cloud Engineer.</p>
